  ...
  class Logs {
    ...
    $onInit() {
      try {
        ...
        this.scope.$on('khulnasoftFetched', (ev, params) => {
          ev.stopPropagation()
     ...
     */
    sort() {
      this.scope.$broadcast('khulnasoftSort', { field: 'timestamp' })
    }
    ...
    playRealtime() {
      ...
      this.scope.$broadcast('khulnasoftPlayRealTime')
    }
    ...
    stopRealtime() {
      this.scope.realtime = false
      this.scope.$broadcast('khulnasoftStopRealTime')
    }
  }
