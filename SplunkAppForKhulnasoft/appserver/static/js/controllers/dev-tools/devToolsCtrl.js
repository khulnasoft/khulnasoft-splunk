...
/*
 * Khulnasoft App - API console - Dev tools controller
  ...
  class DevToolsController {
    ...
    $onInit() {
      try {
        ...
        this.$scope.help = () => {
          this.$window.open(
            `https://documentation.khulnasoft.com/${this.appDocuVersion}/user-manual/api/reference.html`
          )
        }
    ...
    initButtons() {
      ...
      $('#play_button')
        ...
        .show()
      $('#khulnasoft_dev_tools_documentation')
        .offset({
          top: coords.top + 35,
        })
        .show()
    ...
    updateButtons(coords, docuLink = '') {
      ...
      docuLink === ''
        ? $('#khulnasoft_dev_tools_documentation').hide()
        : $('#khulnasoft_dev_tools_documentation').show()
      this.selectedGroup === null
        ? $('#play_button').hide()
        : $('#play_button').show()
      ...
      $('#khulnasoft_dev_tools_documentation').attr('href', docuLink).offset({
        top: coords.top,
      })
    }
    ...
    /**
     * Makes a request to the Khulnasoft API
