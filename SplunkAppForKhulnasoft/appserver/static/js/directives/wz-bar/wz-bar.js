/*
 * Khulnasoft app - Filter bar directive
...
define(['../module'], function (directives) {
  'use strict'
  directives.directive('khulnasoftBar', function ($notificationService, BASE_URL) {
    return {
      restrict: 'E',
      ...
      templateUrl:
        BASE_URL +
        '/static/app/SplunkAppForKhulnasoft/js/directives/wz-bar/wz-bar.html',
    }
  })
})
