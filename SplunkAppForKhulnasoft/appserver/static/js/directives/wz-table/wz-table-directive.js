...
define([
  ...
  'use strict'
  app.directive('khulnasoftTable', function (BASE_URL) {
    return {
      restrict: 'E',
      scope: {
        path: '=path',
      ...
      controller(
        ...
        const fetch = async (options = {}) => {
          try {
            ...
            $scope.searchTable()
            $scope.$emit('khulnasoftFetched', { items })
            return
          } catch (error) {
            if (
              error &&
      ...
      templateUrl:
        BASE_URL +
        '/static/app/SplunkAppForKhulnasoft/js/directives/wz-table/wz-table.html',
    }
  })
})
