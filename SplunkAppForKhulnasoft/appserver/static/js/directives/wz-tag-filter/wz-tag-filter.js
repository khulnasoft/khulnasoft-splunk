/*
 * Khulnasoft app - Khulnasoft search and filter by tags bar
...
define(['../module'], function (app) {
  ...
  app.directive('wzTagFilter', function (BASE_URL) {
    return {
            ...
            groups.forEach((group, idx) => {
              ...
              if (search) {
                ...
                group
                  ...
                  .forEach((tag, idx2) => {
                    const [dataModelTag] = $scope.dataModel.filter(
                      (c) => c.key === tag.key
                    )
      ...
      templateUrl:
        BASE_URL +
        '/static/app/SplunkAppForKhulnasoft/js/directives/wz-tag-filter/wz-tag-filter.html',
    }
  })
})
