/*
 * Khulnasoft app - Card slider directive
...
define(['../module'], function (directives) {
  'use strict'
  directives.directive('khulnasoftCardSlider', function (BASE_URL) {
    return {
      restrict: 'E',
      scope: {
        data: '=data',
      ...
      templateUrl:
        BASE_URL +
        '/static/app/SplunkAppForKhulnasoft/js/directives/wz-card-slider/wz-card-slider.html',
    }
  })
})
