/*
 * Khulnasoft app - Khulnasoft upload files directive
    ...
    return {
      ...
      controller($scope, $currentDataService) {
        ...
        $scope.myDropzone = new Dropzone('#myDropzone', {
          url: `en-us/custom/SplunkAppForKhulnasoft/manager/upload_file?apiId=${currentApi}&resource=${$scope.resource}`,
      ...
      templateUrl:
        BASE_URL +
        '/static/app/SplunkAppForKhulnasoft/js/directives/wz-upload-files/wz-upload-files.html',
    }
  })
})
