/*
 * Khulnasoft app - Top nav bar directive
  ...
  directives.directive('wzMenu', function (BASE_URL) {
    return {
      controller: function (
        ...
        $scope.logoUrl =
          BASE_URL +
          '/static/app/SplunkAppForKhulnasoft/css/images/khulnasoft/svg/khulnasoft_white_full.svg'
        ...
        $scope.openDiscover = (agentId) => {
          ...
          $scope.$applyAsync()
          const index = $currentDataService.getIndex().index || 'khulnasoft'
          //Generate url
        ...
        const renderDropdownIndex = () => {
          ...
          dropdownIndex = new DropdownViz(
            'menuSelectIndex',
            `| metasearch index=* sourcetype=*khulnasoft* | stats count by index, sourcetype | fields index`,
            'index',
            '$form.index$',
            'menuSelectIndex',
            $scope,
        ...
        const update = async () => {
          try {
            ...
            $scope.menuCurrentIndex = !index ? 'khulnasoft' : index.index
      ...
      templateUrl:
        BASE_URL +
        '/static/app/SplunkAppForKhulnasoft/js/directives/wz-menu/wz-menu.html',
    }
  })
})
