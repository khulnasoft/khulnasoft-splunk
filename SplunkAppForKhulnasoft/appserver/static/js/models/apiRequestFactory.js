define(['./module'], function (app) {
  app.factory('$apiRequestModelFactory', function ($requestService) {
    ...
    class HttpRequest {
       ...
       * @param {string} path     Khulnasoft API endpoint
      ...
      /**
       * Sends the request to the backend, meant to be re-sent to the Khulnasoft API
    ...
    class GetRequest extends HttpRequest {
       ...
       * to be used on the backend's request to the Khulnasoft API.
       *
