...
from log import log
from khulnasofttoken import khulnasofttoken


class Khulnasoft_API():
    """
    Khulnasoft_API class.

    Handle the requests sent to the Khulnasoft API.
    """
    ...
    def __init__(self):
        ...
        try:
            ...
            self.logger.error(
                "khulnasoft-api: error in the constructor: %s" % (e))
    ...
    def make_request(
        ...
        """
        Use this method to launch response to a Khulnasoft API.
        ...
        try:
            ...
            khulnasoft_token = self.wztoken.get_auth_token(current_api)
            if method == 'GET':
                if 'origin' in kwargs:
                    if kwargs['origin'] == 'xmlreader':
                        response_xml = self.session.get(
                            ...
                            headers={
                                'Authorization': f'Bearer {khulnasoft_token}'
                            },
