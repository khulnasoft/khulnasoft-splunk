...
KHULNASOFT_HOME = os.path.join(SPLUNK_HOME, "etc", "apps", "SplunkAppForKhulnasoft")

LOGGER = log()


def get_default_conf_path(filename: str) -> str:
    """Returns the absolute path to $KHULNASOFT_HOME/default/${filename}"""
    return os.path.join(KHULNASOFT_HOME, "default", filename)


def get_default_conf(filename: str, stanza: str) -> dict:
    """
    Reads the file $KHULNASOFT_HOME/default/${file} and returns its contents as a
    dictionary.
    ...
    try:
        ...
        # https://github.com/khulnasoft/khulnasoft-splunk/pull/1340#discussion_r900338325
        # ------------------------------
        # app_conf = cli.getAppConf(
        #     confName="app",
        #     app="SplunkAppForKhulnasoft",
        #     use_btool=False,
        #     app_path=KHULNASOFT_HOME
        # )
        # ------------------------------
