# -*- coding: utf-8 -*-
"""
Khulnasoft app - Agents status polling script.
...
def check_status():
    ...
    try:
        ...
        for api in apis:
            ...
            url = api.get_url()
            khulnasoft_token = wztoken.get_auth_token(api)
            ...
            try:
                request_agents = requestsbak.get(
                    ...
                    headers={'Authorization': f'Bearer {khulnasoft_token}'},
                    timeout=1,
                    verify=False
                ).json()
