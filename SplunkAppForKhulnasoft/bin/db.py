#
# Khulnasoft app - Database backend
# Copyright (C) 2018 Khulnasoft, Inc.
#
...
class database():
    ...
    Handles the Splunk's KV store, where the the information of the Khulnasoft APIs
    are stored.
    ...
    def __init__(self, entityName):
        ...
        self.kvstoreUri = entity.buildEndpoint(
            ...
            owner="nobody",
            namespace="SplunkAppForKhulnasoft",
